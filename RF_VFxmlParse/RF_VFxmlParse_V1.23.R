...
XML_DIRECTORY <- file.path("/Users/smvega/Desktop/VF Issues and Validations/SD2165_test_xml")
...
if (length(l604) > 0) {
  ...
  o604$STIMULUS_SIZE <- jReplacer(o604$STIMULUS_SIZE, "2.3596852", "V")
  
  o604[o604 == "XXXXXXNOTFOUND"] <- ""
  o604$TEST_PATTERN <- jReplacer(o604$TEST_PATTERN, "60-4", "P60-2")
  write.csv(o604, file.path(XML_DIRECTORY, paste(XML_DATE, "test60-4.csv", sep = "_")), row.names = FALSE,
            na = "")
...
if (length(l302) > 0) {
  ...
  o302$STIMULUS_SIZE <- jReplacer(o302$STIMULUS_SIZE, "2.3596852", "V")
  ...
  ## Writing out part 1
  write.csv(o302, file.path(XML_DIRECTORY, paste(XML_DATE, "test30-2.csv", sep = "_")), row.names = FALSE,
            na = "")
  ...
  write.csv(o302, file.path(XML_DIRECTORY, paste(XML_DATE, "test30-2_FMP.csv", sep = "_")), row.names = FALSE,
            na = "")
}
...
if (length(l242) > 0) {
  ...
  o242$STIMULUS_SIZE <- jReplacer(o242$STIMULUS_SIZE, "2.3596852", "V")
  ...
  write.csv(o242, file.path(XML_DIRECTORY, paste(XML_DATE, "test24-2_xo.csv", sep = "_")), row.names = FALSE,
            na = "")
  ...
  write.csv(o242_FMP, file.path(XML_DIRECTORY, paste(XML_DATE, "test24-2_FMP.csv", sep = "_")), 
            row.names = FALSE, na = "")
  ...
  write.csv(o242_QC, file.path(XML_DIRECTORY, paste(XML_DATE, "test24-2_QC.csv", sep = "_")), 
            row.names = FALSE, na = "")
}
...
if (length(l242C) > 0) {
  ...
  o242C$STIMULUS_SIZE <- jReplacer(o242C$STIMULUS_SIZE, "2.3596852", "V")
  ...
  write.csv(o242C, file.path(XML_DIRECTORY, paste(XML_DATE, "test24-2C_xo.csv", sep = "_")), 
            row.names = FALSE, na = "")
  ...
  write.csv(o242C_FMP, file.path(XML_DIRECTORY, paste(XML_DATE, "test24-2C_FMP.csv", sep = "_")), 
            row.names = FALSE, na = "")
  ...
  write.csv(o242C_QC, file.path(XML_DIRECTORY, paste(XML_DATE, "test24-2C_QC.csv", sep = "_")), 
            row.names = FALSE, na = "")
}
...
if (length(l102) > 0) {
  ...
  #o102$STIMULUS_SIZE <- jReplacer(o102$STIMULUS_SIZE, "", "III")
  o102$STIMULUS_SIZE <- jReplacer(o102$STIMULUS_SIZE, "0.14748032", "III")
  o102$STIMULUS_SIZE <- jReplacer(o102$STIMULUS_SIZE, "2.3596852", "V")
  ...
  write.csv(o102, file.path(XML_DIRECTORY, paste(XML_DATE, "test10-2_FMP.csv", sep = "_")), 
            row.names = FALSE, na = "")
  ...
  write.csv(o102_QC, file.path(XML_DIRECTORY, paste(XML_DATE, "test10-2_QC.csv", sep = "_")),
            row.names = FALSE, na = "")
}
